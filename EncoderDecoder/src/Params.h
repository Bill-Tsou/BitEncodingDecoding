...
/** @brief  define PHYSICAL_SIMULATION when you'd like to connect two encoders to one decoder physically
 *          at the same time, in real wireless environment, comment out this definition
 */
//#define PHYSICAL_SIMULATION
